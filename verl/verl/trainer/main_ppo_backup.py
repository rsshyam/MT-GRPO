...
from deepscaler.rewards.math_reward import deepscaler_reward_fn, deepscaler_reward_fn_test
...
def _select_rm_score_fn(data_source):
    ...
    elif data_source.startswith('test'):
        return deepscaler_reward_fn_test
    else:
