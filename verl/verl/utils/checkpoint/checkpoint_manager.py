...
# ---- CheckpointConfig shim for older verl -----------------------------------
try:
    from verl.trainer.config import CheckpointConfig  # new verl
except Exception:
    # Older verl: no typed CheckpointConfig; we just treat it as "Any"/DictConfig
    CheckpointConfig = Any  # type: ignore

# ---- device helpers shim ----------------------------------------------------
try:
    from verl.utils.device import get_device_name, get_torch_device
except Exception:
    # Fallbacks for older verl without verl.utils.device
    def get_device_name():
